package com.thomasvitale.springioquestion5;

import com.thomasvitale.springioquestion5.model.Answers;
import com.thomasvitale.springioquestion5.model.GameScore;
...
@SpringBootTest(classes = SpringioQuestion5Application.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@TestPropertySource(properties = "game.eventing.enabled=true")
@Testcontainers
public class SpringioQuestion5ApplicationTests {
    ...
    void whenAnswersSubmittedThenGameScoreReturned() throws InterruptedException {
        ...
        webTestClient
                ...
                .expectBody(GameScore.class).value(gameScore -> {
                    ...
                    assertThat(gameScore.level()).isEqualTo("springio-question-5");
